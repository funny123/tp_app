<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:66:"E:\www\tp_app\public/../application/admin\view\index\pro_list.html";i:1471342527;s:58:"E:\www\tp_app\public/../application/admin\view\layout.html";i:1471333352;s:68:"E:\www\tp_app\public/../application/admin\view\index\admin_left.html";i:1471249480;s:67:"E:\www\tp_app\public/../application/admin\view\index\admin_top.html";i:1470894365;s:67:"E:\www\tp_app\public/../application/admin\view\index\admin_btn.html";i:1470894444;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
                ...
                <div class="show" style="display:block">
                    <div>
                        <select name="cat_id" id="cat_id" value="" name="select"
                            ...
                            <option value="" selected="">选择商品所属分类</option>
                        </select>
                    </div>
                    ...
                    <div class="s_tab">
                        <div class="s_con s_list">
                            <?php if(is_array($pro_list) || $pro_list instanceof \think\Collection): $i = 0; $__LIST__ = $pro_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <section>
                            ...
                            <div><a href="">编辑</a></div>
                            <div><input type="checkbox" name="join[]" value="<?php echo $vo['id']; ?>"></div>
                            </section>
